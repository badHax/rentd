...
namespace Rentd.IdServer.Controllers
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                user = new User() { UserName = email, Email = email,LockoutEnabled = false};
            ...
            await HttpContext.SignInAsync(userIdClaim.Value, user.UserName, provider, props,
